              ...
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={chartData} margin={{ top: 25, right: 10, left: 0, bottom: 5 }}>
                  ...
                  <Bar dataKey="dom" fill="#C9A84C" radius={[2, 2, 0, 0]}>
                    <LabelList dataKey="dom" position="top" fill="#C9A84C" style={{ fontFamily: 'var(--font-sans)', fontSize: '13px' }} />
                  </Bar>
                </BarChart>
              </ResponsiveContainer>
            </ChartCard>
              ...
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={chartData} margin={{ top: 25, right: 10, left: 0, bottom: 5 }}>
                  ...
                  <Line type="monotone" dataKey="ratio" stroke="#C9A84C" strokeWidth={2} dot={{ fill: '#C9A84C', r: 4 }}>
                    <LabelList dataKey="ratio" position="top" formatter={(v: number) => `${v.toFixed(1)}%`} fill="#C9A84C" style={{ fontFamily: 'var(--font-sans)', fontSize: '13px' }} />
                  </Line>
                </LineChart>
              </ResponsiveContainer>
            </ChartCard>
